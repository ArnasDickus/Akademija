import SettingsAccountPage from 'components/lang/settings/settings-account/settings-account.page';
...
const SettingsAccountHome: NextPage = () => {
  // const { pageSeo } = props
  return (
    <>
      {/* <Head>
...
export default SettingsAccountHome;
