import CloseAccountPage from 'components/lang/settings/settings-close-account/settings-close-account.page';
...
const SettingsCloseAccountHome: NextPage = () => {
  // const { pageSeo } = props
  return (
    <>
      {/* <Head>
...
export default SettingsCloseAccountHome;
